...
#define CM0(methodName, returnType) static returnType methodName() {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<> invocation(methodName);  return CTMHandler::getInstance().invokeMock<returnType>(invocation);}
#define CM1(methodName, returnType, argType1) static returnType methodName(argType1 arg1) {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<argType1> invocation(methodName, arg1);  return CTMHandler::getInstance().invokeMock<returnType, argType1>(invocation);}
#define CM2(methodName, returnType, argType1, argType2) static returnType methodName(argType1 arg1, argType2 arg2) {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<argType1, argType2> invocation(methodName, arg1, arg2);  return CTMHandler::getInstance().invokeMock<returnType, argType1, argType2>(invocation);}
#define CM3(methodName, returnType, argType1, argType2, argType3) static returnType methodName(argType1 arg1, argType2 arg2, argType3 arg3) {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<argType1, argType2, argType3> invocation(methodName, arg1, arg2, arg3);  return CTMHandler::getInstance().invokeMock<returnType, argType1, argType2, argType3>(invocation);}
#define CM4(methodName, returnType, argType1, argType2, argType3, argType4) static returnType methodName(argType1 arg1, argType2 arg2, argType3 arg3, argType4 arg4) {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<argType1, argType2, argType3, argType4> invocation(methodName, arg1, arg2, arg3, arg4);  return CTMHandler::getInstance().invokeMock<returnType, argType1, argType2, argType3, argType4>(invocation);}
#define CM5(methodName, returnType, argType1, argType2, argType3, argType4, argType5) static returnType methodName(argType1 arg1, argType2 arg2, argType3 arg3, argType4 arg4, argType5 arg5) {volatile const char* _ctm_marker = __FUNCSIG__; CTMInvocation<argType1, argType2, argType3, argType4, argType5> invocation(methodName, arg1, arg2, arg3, arg4, arg5);  return CTMHandler::getInstance().invokeMock<returnType, argType1, argType2, argType3, argType4, argType5>(invocation);}
